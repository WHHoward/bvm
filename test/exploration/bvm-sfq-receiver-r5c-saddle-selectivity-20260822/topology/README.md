# bvm-sfq-receiver-r5c-saddle-selectivity-20260822 topology
...
- source deck：`test/exploration/bvm-sfq-receiver-r5c-saddle-selectivity-20260822/inputs/read1.cir`
...
- `.include r5c-receiver.cir`

- subcircuit：`BVM`
- subcircuit：`R5A_SOURCE_CAPTURE`

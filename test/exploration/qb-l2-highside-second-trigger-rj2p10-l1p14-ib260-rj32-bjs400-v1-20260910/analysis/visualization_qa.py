...
COMPARISON_NAMES = ("L2_SECOND_TRIGGER_0001_COMPARE.html", "L2_SECOND_TRIGGER_0011_COMPARE.html")
...
def main() -> int:
    ...
    if {entry.get("output_path") for entry in comparisons} != expected_comparison:
        failures.append("comparison paths are not exactly L2_SECOND_TRIGGER_0001/L2_SECOND_TRIGGER_0011")
    ...
    qa = {
        "schema": "bjs400-l2-highside-second-trigger-visualization-qa-v1",

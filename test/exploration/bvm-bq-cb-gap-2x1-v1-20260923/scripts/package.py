...
ZIP_PATH = ROOT / "handoff" / "bvm-bq-cb-gap-2x1-v1-20260923_raw_handoff.zip"
...
def package() -> dict[str, Any]:
    ...
    if preflight.get("status") != "PASS" or execution.get("status") != "ALL_FOUR_SOLVES_AND_RAW_QA_PASS":
    ...
    qa = {"schema": "bvm-bq-cb-gap-package-qa-v1", "status": "PASS",
          ...
          "raw_mechanical_qa": "PASS", "standalone_plot_qa": plot_qa["status"],

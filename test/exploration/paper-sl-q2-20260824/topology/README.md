...
- source deck：`test/exploration/paper-sl-q2-20260824/inputs/40u/paper-j1-logical1-read.cir`
...
- `paper-j1-logical1-read0-control`：[`topology.svg`](variants/paper-j1-logical1-read0-control/topology.svg)，source `test/exploration/paper-sl-q2-20260824/reference/invalid-attempt-01/inputs/37p5u/paper-j1-logical1-read0-control.cir`；4 primitives / 0 mutuals。

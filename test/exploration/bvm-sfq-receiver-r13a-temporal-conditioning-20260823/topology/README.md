# bvm-sfq-receiver-r13a-temporal-conditioning-20260823 topology
...
- source deck：`test/exploration/bvm-sfq-receiver-r13a-temporal-conditioning-20260823/inputs/c2-hold20/read1.cir`
- topology.svg：23 primitives，0 mutuals。

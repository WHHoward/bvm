#!/usr/bin/env python3
"""Minimal visualization QA for RJ1 switched-regime plots."""
...
def check_entry(entry: dict[str, Any], failures: list[str]) -> None:
    ...
    if entry.get("stage") == "standalone":
        ...
        if not str(input_path).startswith("/tmp/rj1-switched-regime-") or input_path.exists():
...
def main() -> int:
    ...
    qa = {
        "schema": "rj1-switched-regime-visualization-qa-v1",

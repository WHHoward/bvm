# qb-q1-canonical-bvm-scaled-qb-compatibility-20260824 topology
...
- source deck：`test/exploration/qb-q1-canonical-bvm-scaled-qb-compatibility-20260824/inputs/logical1-read.cir`
- topology.svg：37 primitives，0 mutuals。

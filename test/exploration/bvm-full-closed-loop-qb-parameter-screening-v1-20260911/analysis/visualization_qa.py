...
def main() -> int:
    ...
    for entry in standalone:
        ...
        if "Phase (turns) [rad/2pi]" not in html and any(label.startswith("P(") for label in entry.get("labels", [])):

# bvm-sfq-receiver-r2a-coupling-20260821 topology
...
- source deck：`test/exploration/bvm-sfq-receiver-r2a-coupling-20260821/inputs/diff-a010-b007-k080-read1.cir`
...
- `.include diff-a010-b007-k080-receiver.cir`

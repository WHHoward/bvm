# jtl-transport-gate-v1-numerical-freeze-20260824-rerun topology
...
- source deck：`test/exploration/jtl-transport-gate-v1-numerical-freeze-20260824-rerun/inputs/r11/0p025/main.cir`
...
- `main`：[`topology.svg`](variants/main/topology.svg)，source `test/exploration/jtl-transport-gate-v1-numerical-freeze-20260824-rerun/inputs/pulse5-reverse/0p025/main.cir`；30 primitives / 0 mutuals。

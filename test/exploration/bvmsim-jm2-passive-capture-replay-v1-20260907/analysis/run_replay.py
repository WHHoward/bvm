#!/usr/bin/env python3
"""Run exactly the two preregistered replay cases after replay preflight."""
...
CASES = ("replay_single", "replay_array")
...
def main() -> int:
    ...
    print(json.dumps({"status": "PASS", "physical_run_count": 2, "summary": "analysis/replay_execution_summary.json"}, ensure_ascii=False))
    return 0

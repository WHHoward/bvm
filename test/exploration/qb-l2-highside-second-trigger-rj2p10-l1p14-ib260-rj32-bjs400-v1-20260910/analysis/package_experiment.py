...
PACKAGE_RELATIVE = "handoff/qb-l2-highside-second-trigger-rj2p10-l1p14-ib260-rj32-bjs400-v1-20260910_corrected-v2_raw_handoff.zip"
...
def main() -> int:
    ...
    required = {
        ...
        "visualization/manifest.json", "handoff/PACKAGE_QA_v1.json",
    }
    failures: list[str] = []

#!/usr/bin/env python3
"""analyze_d0 -- deterministic analysis for JH-20260814-BVM-S0-D0-001 A01.
...
RUN = REPO_ROOT / "test/final/bvm/runs/bvm-s0-d0-20260814-01"
...
def main() -> int:
    results: dict = {"run": "bvm-s0-d0-20260814-01", "cases": {}}
    per_case = {}
    for c in CASES:

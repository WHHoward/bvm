# bvm-sfq-receiver-r11a-direct-jtl-compatibility-20260823 topology
...
- source deck：`test/exploration/bvm-sfq-receiver-r11a-direct-jtl-compatibility-20260823/inputs/read1.cir`
- topology.svg：54 primitives，0 mutuals。
...
- `positive-control`：[`topology.svg`](variants/positive-control/topology.svg)，source `test/exploration/bvm-sfq-receiver-r11a-direct-jtl-compatibility-20260823/inputs/positive-control.cir`；32 primitives / 0 mutuals。

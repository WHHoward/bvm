...
def make_record(run_id: str, head: str, command: list[str], started: str, finished: str, exit_code: int, deck: Path, raw: Path, log: Path) -> dict[str, Any]:
    return {
        "schema": "rj1-switched-regime-run-metadata-v1",
        "experiment_id": EXP.name,
        "run_id": run_id,
        "topology": "ARRAY",
        "working_point": {"L1_pH": 1.6, "IBias_uA": 260.0, "RJ1_ohm": RUN_TO_RJ1[run_id]},
        "rj1_ohm": RUN_TO_RJ1[run_id],
        "mask": RUN_TO_MASK[run_id],
        "parameters": {"L1_pH": 1.6, "IBias_uA": 260.0, "RJ1_ohm": RUN_TO_RJ1[run_id]},

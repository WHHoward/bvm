# bvm-sfq-receiver-r10a-local-bjl2-bias-20260823 topology
...
- source deck：`test/exploration/bvm-sfq-receiver-r10a-local-bjl2-bias-20260823/inputs/read1.cir`
- topology.svg：43 primitives，1 mutuals。
...
- `.include bq_cell_paper_r10a_local_bias.cir`

- subcircuit：`BQ_PAPER_R10A`
- subcircuit：`BVM`

# bvm-sfq-receiver-r1c-bias-margin-20260821 topology
...
- source deck：`test/exploration/bvm-sfq-receiver-r1c-bias-margin-20260821/inputs/diff-a010-b006-r100-read1.cir`
...
- `.include diff-a010-b006-r100-receiver.cir`

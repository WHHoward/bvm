# ideal source waveform replay → scaled QB publication schematic

这是一张由实际 representative deck 生成的论文级语义原理图，不是 Graphviz connectivity graph。

- topology_id：`SCALED_QB_REPLAY`
- representative deck：`test/exploration/bvm-load-qb-matrix-v1-20260901/inputs/replay/13ps/12x320/logical1_read.cir`
- topology signature：`ideal-replay-scaled-qb-rload`

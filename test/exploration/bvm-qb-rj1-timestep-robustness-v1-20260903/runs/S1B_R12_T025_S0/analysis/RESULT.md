...
- family: `single_bvm_protection`; RJ1: `12.0 ohm`; timestep: `0.025 ps`; state: `S0`
- effective raw: `test/exploration/bvm-qb-rj1-timestep-robustness-v1-20260903/runs/S1B_R12_T025_S0/raw/run-01.csv` (`run-01`)
- artifact status: **VALID**

## Observed / derived key data

- actual grid: `0.025000 ps`, saved `0.000..199.975 ps`, interpolation: none
- BJ2 READ1 net trajectory: `0.000010 turn`; complete segments: `0`; clean separated events: `0`

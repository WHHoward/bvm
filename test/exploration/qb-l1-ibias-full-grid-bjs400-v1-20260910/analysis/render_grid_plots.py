#!/usr/bin/env python3
"""Render exactly 30 standalone and two full-grid whole-run pages."""
...
NEW_RUNS = (
    "ARRAY_L1P12_IB260_0001", "ARRAY_L1P12_IB260_0011",
    "ARRAY_L1P12_IB270_0001", "ARRAY_L1P12_IB270_0011",
    "ARRAY_L1P14_IB260_0001", "ARRAY_L1P14_IB260_0011",
    "ARRAY_L1P14_IB270_0001", "ARRAY_L1P14_IB270_0011",
    "ARRAY_L1P16_IB270_0001", "ARRAY_L1P16_IB270_0011",
)
REUSE_RUNS = (
    "ARRAY_L1P12_0001", "ARRAY_L1P12_0011",
    "ARRAY_L1P14_0001", "ARRAY_L1P14_0011",
    "ARRAY_IB260_0001", "ARRAY_IB260_0011",
    "ARRAY_IB270_0001", "ARRAY_IB270_0011",
    "ARRAY_L1P20_IB250_0001", "ARRAY_L1P20_IB250_0011",
    "ARRAY_L1P16_IB250_0001", "ARRAY_L1P16_IB250_0011",
    "ARRAY_L1P16_IB260_0001", "ARRAY_L1P16_IB260_0011",
)
...
GRID_CASES = (
    ((1.2, 250), ("ARRAY_L1P12_0001", "ARRAY_L1P12_0011")),
    ((1.2, 260), ("ARRAY_L1P12_IB260_0001", "ARRAY_L1P12_IB260_0011")),
    ((1.2, 270), ("ARRAY_L1P12_IB270_0001", "ARRAY_L1P12_IB270_0011")),
    ((1.4, 250), ("ARRAY_L1P14_0001", "ARRAY_L1P14_0011")),
    ((1.4, 260), ("ARRAY_L1P14_IB260_0001", "ARRAY_L1P14_IB260_0011")),
    ((1.4, 270), ("ARRAY_L1P14_IB270_0001", "ARRAY_L1P14_IB270_0011")),
    ((1.6, 250), ("ARRAY_L1P16_IB250_0001", "ARRAY_L1P16_IB250_0011")),
    ((1.6, 260), ("ARRAY_L1P16_IB260_0001", "ARRAY_L1P16_IB260_0011")),
    ((1.6, 270), ("ARRAY_L1P16_IB270_0001", "ARRAY_L1P16_IB270_0011")),
    ((2.0, 250), ("ARRAY_L1P20_IB250_0001", "ARRAY_L1P20_IB250_0011")),
    ((2.0, 260), ("ARRAY_IB260_0001", "ARRAY_IB260_0011")),
    ((2.0, 270), ("ARRAY_IB270_0001", "ARRAY_IB270_0011")),
)
...
def raw_path(case_id: str) -> Path:
    return RUN_PATHS[case_id] / "raw.csv"
...
def standalone_labels(name: str) -> list[str]:
    if name == "SIGNAL_PATH":
        return [
            "I(I_WL3)", "I(I_SE3)", "I(I_WL4)", "I(I_SE4)",
            "I(L_SL|XBVM3)", "I(L_SL|XBVM4)",
            "V(COMMON_SL)", "I(B_JSL8)", "V(QBIN)", "V(QBOUT)",
...
def base_entry(stage: str, name: str, input_path: Path, output_path: Path, labels: list[str], sources: list[Path], command: list[str]) -> dict[str, object]:
...
def write_comparison_csv(path: Path, case_ids: list[str], labels: list[str]) -> str:
    traces = [trace(raw_path(case_id)) for case_id in case_ids]
...
def render_standalone(entries: list[dict[str, object]]) -> None:
    for run_id in NEW_RUNS:
        ...
        for name in STANDALONE_NAMES:
            ...
            entries.append(base_entry("standalone", name, source, output, labels, [source], command))
...
def render_comparison(entries: list[dict[str, object]], name: str, case_ids: list[str]) -> None:
    ...
    temp_path = Path(tempfile.mkstemp(prefix="bjs400-full-grid-", suffix=".csv", dir="/tmp")[1])
    try:
        ...
        record = base_entry("comparison", name, temp_path, output, plot_labels, [raw_path(case_id) for case_id in case_ids], command)
...
def write_run_summaries() -> list[Path]:
    ...
    for run_id in NEW_RUNS:
        ...
        lines = [
            f"# {run_id} — compact full-grid evidence",
            "",
...
def main() -> int:
    ...
    for mask_index, mask in enumerate(("0001", "0011")):
        render_comparison(
            entries,
            f"L1_IBIAS_GRID_{mask}_COMPARE",
            [pair[1][mask_index] for pair in GRID_CASES],
        )
    summaries = write_run_summaries()
    standalone = [entry for entry in entries if entry["stage"] == "standalone"]
    comparisons = [entry for entry in entries if entry["stage"] == "comparison"]
    manifest = {
        "schema": "bjs400-l1-ibias-full-grid-flat-visualization-manifest-v1",
        ...
        "grid_points": [
            {"L1_pH": l1, "IBias_uA": ibias, "case_ids": list(pair)}
            for (l1, ibias), pair in GRID_CASES
        ],
        "scientific_analysis_performed": False,
        "no_focused_window_plots": True,
        "no_extra_comparison_plots": True,
        "status": "PASS" if len(standalone) == 30 and len(comparisons) == 2 else "FAIL",
    }

#!/usr/bin/env python3
"""Minimal visualization QA for fixed-point L2 re-arm plots."""
...
def check_entry(entry: dict[str, Any], failures: list[str]) -> None:
    ...
    if entry.get("stage") == "standalone":
        ...
        if not str(input_path).startswith("/tmp/l2-rearm-") or input_path.exists():
...
def main() -> int:
    ...
    qa = {
        "schema": "bjs400-l2-rearm-visualization-qa-v1",

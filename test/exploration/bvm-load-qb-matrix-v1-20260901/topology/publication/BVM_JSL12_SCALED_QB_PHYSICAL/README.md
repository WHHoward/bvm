# BVM → 12×JSL → scaled QB physical cascade publication schematic

这是一张由实际 representative deck 生成的论文级语义原理图，不是 Graphviz connectivity graph。

- topology_id：`BVM_JSL12_SCALED_QB_PHYSICAL`
- representative deck：`test/exploration/bvm-load-qb-matrix-v1-20260901/inputs/physical/13ps/12x320/logical1_read.cir`
- topology signature：`physical-bvm-jsl12-scaled-qb-rload`

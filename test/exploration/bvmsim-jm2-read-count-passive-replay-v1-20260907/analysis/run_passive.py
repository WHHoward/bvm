#!/usr/bin/env python3
"""Run exactly the three new N2-N4 passive capture cases."""
...
CASES = ("n2_passive", "n3_passive", "n4_passive")
...
def main() -> int:
    preflight = json.loads((EXP / "analysis/topology_preflight.json").read_text(encoding="utf-8"))
    if preflight.get("status") != "PASS":
        raise RuntimeError("passive topology preflight did not pass")
    ...
    for case in CASES:
        ...
        metadata = {
            ...
            "solver": solver,
            "artifacts": artifact,
            "topology_preflight": "analysis/topology_preflight.json",
    ...
    summary = {
        "schema": "jm2-read-count-passive-execution-summary-v1",
        "experiment_id": EXP.name,
    ...
    print(json.dumps({"status": "PASS", "physical_run_count": 3, "summary": "analysis/passive_execution_summary.json"}, ensure_ascii=False))
    return 0

# bvm-sfq-receiver-r4a-weak-mutual-capture-20260822 topology
...
- source deck：`test/exploration/bvm-sfq-receiver-r4a-weak-mutual-capture-20260822/inputs/read1.cir`
- topology.svg：33 primitives，1 mutuals。
...
- `.include r4a-receiver.cir`

- subcircuit：`BVM`
- subcircuit：`R4A_SOURCE_CAPTURE`

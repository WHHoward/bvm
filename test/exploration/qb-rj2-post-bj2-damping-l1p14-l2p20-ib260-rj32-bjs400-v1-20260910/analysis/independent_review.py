...
RJ2_BY_RUN.update({run_id: 4.0 for run_id in REUSE_RUNS})
...
def main() -> int:
    ...
    probes.update({
        "no_op_parameterization": len(set(deck_hashes.values())) == 8 and {RJ2_BY_RUN[run_id] for run_id in NEW_RUNS} == {2.0, 3.0, 6.0},
    ...
    result = {
        "schema": "bjs400-rj2-damping-independent-review-v1",

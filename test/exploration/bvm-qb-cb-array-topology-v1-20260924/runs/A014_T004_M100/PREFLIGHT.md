...
- ARRAY_SIZE: `3`
- FINAL READ MASK: `100` (leftmost bit is BVM1)
- topology: `{"POST_SJTL_CB": [1, 1, 0], "QB_CB": [1, 1, 1], "SJTL_COUNT": [1, 1, 1]}`
- DT: `0.01p`; STOP: `200p`
- run matrix: exactly `A014_T004_M100` / mask `100`
- expected raw: `runs/A014_T004_M100/raw.csv`

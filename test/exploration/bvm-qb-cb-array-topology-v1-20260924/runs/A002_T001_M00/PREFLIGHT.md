...
- run_id: `A002_T001_M00`
- parent HEAD: `4f71482628740ddb3bb6b5c821937aa5500fb743`
...
- ARRAY_SIZE: `2`
- FINAL READ MASK: `00` (leftmost bit is BVM1)
- topology: `{"POST_SJTL_CB": [1, 0], "QB_CB": [1, 1], "SJTL_COUNT": [3, 1]}`
- DT: `0.01p`; STOP: `200p`
- run matrix: exactly `A002_T001_M00` / mask `00`
- expected raw: `runs/A002_T001_M00/raw.csv`
...
- `circuits/qb/BQ_0923.cir` (76a8b5acf5fb23c29f338e6b71ac69e2dae261f2b0b6d1f103b653a4ad6f92d2) → `snapshot/sources/BQ_tunable.cir` SHA-256 `8c0bfa584616ff7544772f582a1083cc7297552ac9b0f05fa791adc3ed52afa2`

...
def head_relation(preflight_head: str) -> dict[str, Any]:
    ...
    post_handoff_analysis = ancestor and bool(changed) and all(path == prefix.rstrip("/") or path.startswith(prefix) for path in changed)

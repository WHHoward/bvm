...
def main() -> int:
    ...
    render_comparison(entries, "L2_SECOND_TRIGGER_0001_COMPARE", COMPARISON_CASES["0001"])
    render_comparison(entries, "L2_SECOND_TRIGGER_0011_COMPARE", COMPARISON_CASES["0011"])
    ...
    manifest = {
        "schema": "bjs400-l2-highside-second-trigger-flat-visualization-manifest-v1",

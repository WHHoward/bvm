...
REGISTERED_NEW_RUNS = (
    "ARRAY_L1P14_L2P24_IB260_RJ32_RJ2P10_0001",
    "ARRAY_L1P14_L2P24_IB260_RJ32_RJ2P10_0011",
    "ARRAY_L1P14_L2P28_IB260_RJ32_RJ2P10_0001",
    "ARRAY_L1P14_L2P28_IB260_RJ32_RJ2P10_0011",
    "ARRAY_L1P14_L2P32_IB260_RJ32_RJ2P10_0001",
    "ARRAY_L1P14_L2P32_IB260_RJ32_RJ2P10_0011",
)
...
L2_BY_RUN = {run_id: float(re.search(r"L2P(\d+)", run_id).group(1)) / 10.0 for run_id in NEW_RUNS}
L2_BY_RUN.update({run_id: 2.0 for run_id in REUSE_RUNS})
RJ2_BY_RUN = {run_id: 10.0 for run_id in ALL_RUNS}
...
def main() -> int:
    ...
    for run_id, (_header, times, columns) in traces.items():
        ...
        compare(failures, f"{run_id} RJ2 fixed value", RJ2_BY_RUN[run_id], case.get("RJ2_ohm"))
        compare(failures, f"{run_id} L2 value", L2_BY_RUN[run_id], case.get("L2_pH"))
    ...
    for run_id in NEW_RUNS:
        ...
        compare(failures, f"{run_id} metadata L2", L2_BY_RUN[run_id], value.get("l2_pH"))
        ...
        if f".param L2_VALUE={L2_BY_RUN[run_id]:g}p" not in deck_text:
            failures.append(f"L2 deck parameter mismatch: {run_id}")
    ...
    result = {
        "schema": "bjs400-l2-highside-second-trigger-independent-review-v1",

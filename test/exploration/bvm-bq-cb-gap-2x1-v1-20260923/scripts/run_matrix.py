...
def run_one(item: dict[str, Any], preflight: dict[str, Any], source_lock: dict[str, Any], execution: dict[str, Any]) -> dict[str, Any]:
    ...
    metadata = {
        "schema": "bvm-bq-cb-gap-run-metadata-v1", "run_id": run_id,
    ...
    source_manifest = {
        "schema": "bvm-bq-cb-gap-source-manifest-v1", "run_id": run_id,
...
def main() -> int:
    ...
    execution = {"schema": "bvm-bq-cb-gap-execution-v1", "experiment_id": matrix["experiment_id"],
    ...
    execution["status"] = "ALL_FOUR_SOLVES_AND_RAW_QA_PASS"

#!/usr/bin/env python3
"""Render the frozen compact L2 whole-run visualization set."""
...
NEW_RUNS = (
    "ARRAY_L1P14_L2P16_IB260_RJ32_0001", "ARRAY_L1P14_L2P16_IB260_RJ32_0011",
    "ARRAY_L1P14_L2P12_IB260_RJ32_0001", "ARRAY_L1P14_L2P12_IB260_RJ32_0011",
    "ARRAY_L1P14_L2P08_IB260_RJ32_0001", "ARRAY_L1P14_L2P08_IB260_RJ32_0011",
)
...
COMPARISON_CASES = {
    "0001": [
        ...
        "ARRAY_L1P14_L2P16_IB260_RJ32_0001",
        "ARRAY_L1P14_L2P12_IB260_RJ32_0001",
        "ARRAY_L1P14_L2P08_IB260_RJ32_0001",
    ],
    "0011": [
        "ARRAY_L1P14_IB260_RJ32_0011",
        "ARRAY_L1P14_L2P16_IB260_RJ32_0011",
        "ARRAY_L1P14_L2P12_IB260_RJ32_0011",
        "ARRAY_L1P14_L2P08_IB260_RJ32_0011",
    ],
}
...
def render_comparison(entries: list[dict[str, object]], name: str, case_ids: list[str]) -> None:
    ...
    temp_path = Path(tempfile.mkstemp(prefix="l2-rearm-", suffix=".csv", dir="/tmp")[1])
    try:
...
def main() -> int:
    ...
    render_comparison(entries, "L2_REARM_0001_COMPARE", COMPARISON_CASES["0001"])
    render_comparison(entries, "L2_REARM_0011_COMPARE", COMPARISON_CASES["0011"])
    ...
    manifest = {
        "schema": "bjs400-l2-rearm-flat-visualization-manifest-v1",

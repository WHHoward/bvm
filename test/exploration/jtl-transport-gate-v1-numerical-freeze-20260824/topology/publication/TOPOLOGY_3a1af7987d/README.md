# jtl-transport-gate-v1-numerical-freeze-20260824 publication schematic

这是一张由实际 representative deck 生成的论文级语义原理图，不是 Graphviz connectivity graph。

- topology_id：`TOPOLOGY_3a1af7987d`
- representative deck：`test/exploration/jtl-transport-gate-v1-numerical-freeze-20260824/inputs/r11/0p025/main.cir`
- topology signature：`194cd42df9988272a7490ccbecf3a396d5889da1f65d73eedf6f22f0968ab801`

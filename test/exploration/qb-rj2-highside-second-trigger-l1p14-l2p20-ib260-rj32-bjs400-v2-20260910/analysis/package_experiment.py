#!/usr/bin/env python3
"""Build and verify the immutable staged RJ2 second-trigger evidence ZIP."""
...
PACKAGE_RELATIVE = "handoff/qb-rj2-highside-second-trigger-l1p14-l2p20-ib260-rj32-bjs400-v2-20260910_raw_handoff.zip"
...
REGISTERED_NEW_RUNS = (
    ...
    "ARRAY_L1P14_L2P20_IB260_RJ32_RJ2P14_0001", "ARRAY_L1P14_L2P20_IB260_RJ32_RJ2P14_0011",
    "ARRAY_L1P14_L2P20_IB260_RJ32_RJ2P16_0001", "ARRAY_L1P14_L2P20_IB260_RJ32_RJ2P16_0011",
)
...
def main() -> int:
    ...
    required = {
        ...
        "qa/independent_review.json", "qa/protocol_audit.json", "analysis/REVIEW.md", "analysis/independent_review.py",
    ...
    with zipfile.ZipFile(zip_path) as archive:
        ...
        if not any(name.startswith("qa/stages/stage") and name.endswith("_decision.json") for name in name_set):
            failures.append("missing staged decision artifacts")
    for run_id in NEW_RUNS:

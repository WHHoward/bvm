# bvm-sfq-receiver-r12a-dcsfq-bvm-reaudit-20260823 topology
...
- `phase-a-zero`：[`topology.svg`](variants/phase-a-zero/topology.svg)，source `test/exploration/bvm-sfq-receiver-r12a-dcsfq-bvm-reaudit-20260823/inputs/phase-a-zero.cir`；23 primitives / 0 mutuals。

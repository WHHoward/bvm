...
BASELINE_N2 = EXP / "references/canonical_baseline/0011/raw.csv"
BASELINE_N3 = EXP / "references/canonical_baseline/0111/raw.csv"
...
def fourth_diagnostics(case: dict[str, Any], baseline: dict[str, Any]) -> dict[str, Any]:
    ...
    for track in ("BJ1", "BJ2", "JTL1", "JTL6"):
        ...
        if current is not None and reference is not None:
            notes.append(f"{track}_4_delta_ps={current - reference:.6g}")
    ...
    return {"near_direct_suppression": near_direct, "terminal_fourth_area_ratio": ratio, "terminal_fourth_delay_ps": delay, "notes": notes}
...
def analyze_pair(point_id: str, changes: dict[str, float], n2_path: Path, n3_path: Path) -> dict[str, Any]:
    ...
    if n2_class["classification"] == "CONTROL_CONTAMINATED" or n3_class["classification"] == "CONTROL_CONTAMINATED":
        ...
        candidate_class = "S"
    elif n2_ok and n3_class["classification"] == "N3_MULTIPLICITY_AMBIGUOUS" and n3_class["fourth_diagnostics"]["near_direct_suppression"]:
        candidate_class = "A"
    elif n2_ok and n3_class["classification"] == "N3_4_COMPLETE":
        candidate_class = "B"
    elif not n2_ok and n3_class["classification"] == "N3_3_COMPLETE":
        candidate_class = "C"
    else:
        candidate_class = "D"
    labels = {"S": "DIRECT_2_TO_3_COMBINATION_CANDIDATE", "A": "NEAR_DIRECT_CANDIDATE", "B": "STILL_2_TO_4", "C": "STILL_1_TO_3", "D": "OTHER_FAILURE"}
...
def main() -> int:
    ...
    if n2_classification == "N2_2_COMPLETE" and n3_classification == "N3_3_COMPLETE":
        threshold_outcome = "DIRECT_2_TO_3_THRESHOLD_WINDOW_FOUND"
    elif n2_classification == "N2_NOT_2" and n3_classification == "N3_3_COMPLETE":
        threshold_outcome = "STILL_1_TO_3"
    elif n2_classification == "N2_NOT_2" and n3_classification == "N3_4_COMPLETE":
        threshold_outcome = "UNFAVORABLE_THRESHOLD_ORDERING"
    elif n2_classification == "N2_2_COMPLETE" and n3_classification == "N3_4_COMPLETE":

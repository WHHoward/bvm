# Evidence manifest — bvm-population-passive-source-replay-rj2p12-l1p14-l2p20-ib260-rj32-bjs400-v1-20260911

This is an evidence-only handoff. Scientific interpretation is `NOT_PERFORMED`.

- Authorized physical solves: `PASSIVE_N2_0011`, `PASSIVE_N3_0111`,
  `PASSIVE_N4_1111`, `REPLAY_N2_0011_RJ2P12`, `REPLAY_N3_0111_RJ2P12`,
  `REPLAY_N4_1111_RJ2P12`.
- Closed-loop comparison evidence: immutable RJ2=12 N2/N3/N4 references.

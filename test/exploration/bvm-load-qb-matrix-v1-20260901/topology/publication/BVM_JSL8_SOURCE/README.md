# BVM → 8×JSL source fixture publication schematic

这是一张由实际 representative deck 生成的论文级语义原理图，不是 Graphviz connectivity graph。

- topology_id：`BVM_JSL8_SOURCE`
- representative deck：`test/exploration/bvm-load-qb-matrix-v1-20260901/inputs/source/13ps/8x500/logical1_read.cir`
- topology signature：`source-boundary-bvm-jsl8-ground`

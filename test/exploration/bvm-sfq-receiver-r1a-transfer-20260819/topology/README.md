# bvm-sfq-receiver-r1a-transfer-20260819 topology
...
- source deck：`test/exploration/bvm-sfq-receiver-r1a-transfer-20260819/inputs/l020-k080-read1.cir`
- topology.svg：31 primitives，1 mutuals。
...
- `.include series_pickup_l020_k080.cir`

- subcircuit：`BVM`
- subcircuit：`SERIES_PICKUP`

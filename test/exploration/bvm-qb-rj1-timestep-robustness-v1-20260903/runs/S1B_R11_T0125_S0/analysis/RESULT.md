...
- family: `single_bvm_protection`; RJ1: `11.0 ohm`; timestep: `0.0125 ps`; state: `S0`
- effective raw: `test/exploration/bvm-qb-rj1-timestep-robustness-v1-20260903/runs/S1B_R11_T0125_S0/raw/run-01.csv` (`run-01`)
...
- BJ2 settling tail: mean V `-0.000000 mV`, RMS V `0.000007 mV`, phase p2p `0.000007 turn`, tail complete segments `0`

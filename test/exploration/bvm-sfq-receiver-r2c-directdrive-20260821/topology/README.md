# bvm-sfq-receiver-r2c-directdrive-20260821 topology
...
- source deck：`test/exploration/bvm-sfq-receiver-r2c-directdrive-20260821/inputs/amp20u0.cir`
- topology.svg：35 primitives，1 mutuals。
...
- `.include amp20u0-receiver.cir`

- subcircuit：`BVM`
- subcircuit：`SERIES_PICKUP_DIFF_SERIES_RETURN`

## 结构变体

- `ctrl-nopulse`：[`topology.svg`](variants/ctrl-nopulse/topology.svg)，source `test/exploration/bvm-sfq-receiver-r2c-directdrive-20260821/inputs/ctrl-nopulse.cir`；34 primitives / 1 mutuals。

#!/usr/bin/env python3
"""Primary raw-CSV analysis for the R1b output-JJ activation Exploration."""
...
TWO_PI = 2.0 * math.pi
POINT_ID = os.environ.get("POINT_ID", "diff-a010-b007-r100")
OUTPUT_BIAS_UA = float(os.environ.get("OUT_BIAS_UA", "7.0"))
POINT = {
    "id": POINT_ID,
    "trigger_area": 0.50,
    ...
    "r_sec_load_ohm": 12.0,
    "output_area": 0.10,
    "output_bias_uA": OUTPUT_BIAS_UA,
    "output_ic_uA": 10.0,
    "output_rn_ohm": 160.0,
    "output_r0_ohm": 1600.0,
    "output_c_fF": 7.0,
    "output_r_damp_ohm": 100.0,
}
CASES = [
...
def main():
    ...
    result = {
        "document_type": "r1c_bias_point_raw_analysis",
        "analysis_version": "r1c-output-bias-1",
        "phi0_Wb": PHI0_WB,
        "metric_boundary": (
    ...
    result["verdict_components"]["r1b_pass"] = all(
    ...
    print("r1b_pass=" + str(result["verdict_components"]["r1b_pass"]))

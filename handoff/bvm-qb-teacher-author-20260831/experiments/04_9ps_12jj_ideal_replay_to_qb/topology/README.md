...
- source deck：`test/exploration/paper-sl-q1-20260824/inputs/paper-j1-logical1-read.cir`
...
- `q0-68p4u-positive-control`：[`topology.svg`](variants/q0-68p4u-positive-control/topology.svg)，source `test/exploration/paper-sl-q1-20260824/inputs/q0-68p4u-positive-control.cir`；13 primitives / 0 mutuals。

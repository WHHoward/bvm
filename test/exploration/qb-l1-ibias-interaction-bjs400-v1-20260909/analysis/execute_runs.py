#!/usr/bin/env python3
"""Execute exactly the six newly authorized interaction runs once."""
...
from prepare_experiment import NEW_RUNS, REUSE_RUNS, RUN_TO_CORNER, RUN_TO_MASK, WORKING_POINTS  # noqa: E402
...
def make_record(run_id: str, head: str, command: list[str], started: str, finished: str, exit_code: int, deck: Path, raw: Path, log: Path) -> dict[str, Any]:
    ...
    return {
        "schema": "bjs400-l1-ibias-interaction-run-metadata-v1",
...
def main() -> int:
    ...
    summary = {
        "schema": "bjs400-l1-ibias-interaction-execution-v1",
        "experiment_id": EXP.name,

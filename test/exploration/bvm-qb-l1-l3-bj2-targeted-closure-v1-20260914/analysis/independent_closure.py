#!/usr/bin/env python3
"""Independent raw reread for the targeted L1/L3/BJ2 closure result."""
...
RESULT = EXP / "screening/results/TARGET_L1_1p2_L3_2_BJ2_2p2.json"
...
REFERENCE_RAW = {
    "R0_canonical_0011": EXP / "references/canonical_l3p13/0011/raw.csv",
    "R0_canonical_0111": EXP / "references/canonical_l3p13/0111/raw.csv",
    "R1_l1_rescue_0011": EXP / "references/l1p12_l3p13_bj2p20/0011/raw.csv",
    "R1_l1_rescue_0111": EXP / "references/l1p12_l3p13_bj2p20/0111/raw.csv",
    "R2_l3_bj2_barrier_0011": EXP / "references/l3p20_bj2p22/0011/raw.csv",
    "R2_l3_bj2_barrier_0111": EXP / "references/l3p20_bj2p22/0111/raw.csv",
}
...
def main() -> int:
    ...
    if validation_records:
        failures.append("unauthorized validation raw present in this experiment")
    if state.get("final_marker") != "EXPERIMENT_COMPLETE / AWAITING_SCIENTIFIC_REVIEW":
        failures.append("final marker missing")
    record = {
        "schema": "bvm-qb-l1-l3-bj2-targeted-closure-independent-review-v1",
    ...
    output = EXP / "qa/independent_closure.json"

...
COMPARISON_NAMES = ["POPULATION_CHAIN_RJ2P11.html", "RJ2P11_VS_RJ2P12_0011.html", "RJ2P11_VS_RJ2P12_0111.html", "RJ2P11_VS_RJ2P12_1111.html"]
...
def main() -> int:
    ...
    if len(standalone) != 24 or len(comparisons) != 4:
    ...
    qa = {
        "schema": "bjs400-rj2p11-midpoint-flat-visualization-qa-v1",

...
- family: `single_bvm_protection`; RJ1: `12.0 ohm`; timestep: `0.0125 ps`; state: `S0`
- effective raw: `test/exploration/bvm-qb-rj1-timestep-robustness-v1-20260903/runs/S1B_R12_T0125_S0/raw/run-01.csv` (`run-01`)
- artifact status: **VALID**

## Observed / derived key data

- actual grid: `0.012500 ps`, saved `0.000..199.988 ps`, interpolation: none
- BJ2 READ1 net trajectory: `0.000020 turn`; complete segments: `0`; clean separated events: `0`
- BJ2 continuous multi-turn status in READ1: `False`
- BJ2 settling tail: mean V `-0.000000 mV`, RMS V `0.000008 mV`, phase p2p `0.000008 turn`, tail complete segments `0`

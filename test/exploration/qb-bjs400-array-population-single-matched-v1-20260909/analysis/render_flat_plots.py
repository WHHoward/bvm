#!/usr/bin/env python3
"""Render the frozen flat whole-run BJS400 visualization set.
...
RUNS = OrderedDict(
    (
        ("ARRAY_L1P12_0000", "runs/ARRAY_L1P12_0000"),
        ("ARRAY_L1P12_1000", "runs/ARRAY_L1P12_1000"),
        ("ARRAY_L1P12_0001", "runs/ARRAY_L1P12_0001"),
        ("ARRAY_L1P12_0011", "runs/ARRAY_L1P12_0011"),
        ("ARRAY_L1P14_0000", "runs/ARRAY_L1P14_0000"),
        ("ARRAY_L1P14_1000", "runs/ARRAY_L1P14_1000"),
        ("ARRAY_L1P14_0001", "runs/ARRAY_L1P14_0001"),
        ("ARRAY_L1P14_0011", "runs/ARRAY_L1P14_0011"),
        ("ARRAY_IB260_0000", "runs/ARRAY_IB260_0000"),
        ("ARRAY_IB260_1000", "runs/ARRAY_IB260_1000"),
        ("ARRAY_IB260_0001", "runs/ARRAY_IB260_0001"),
        ("ARRAY_IB260_0011", "runs/ARRAY_IB260_0011"),
        ("ARRAY_IB270_0000", "runs/ARRAY_IB270_0000"),
        ("ARRAY_IB270_1000", "runs/ARRAY_IB270_1000"),
        ("ARRAY_IB270_0001", "runs/ARRAY_IB270_0001"),
        ("ARRAY_IB270_0011", "runs/ARRAY_IB270_0011"),
        ("SINGLE_L1P12_0", "runs/SINGLE_L1P12_0"),
        ("SINGLE_L1P12_1", "runs/SINGLE_L1P12_1"),
        ("SINGLE_L1P14_0", "runs/SINGLE_L1P14_0"),
        ("SINGLE_L1P14_1", "runs/SINGLE_L1P14_1"),
        ("SINGLE_IB260_0", "runs/SINGLE_IB260_0"),
        ("SINGLE_IB260_1", "runs/SINGLE_IB260_1"),
        ("SINGLE_IB270_0", "runs/SINGLE_IB270_0"),
        ("SINGLE_IB270_1", "runs/SINGLE_IB270_1"),
    )
)
SETTINGS = ("L1P12", "L1P14", "IB260", "IB270")
MASKS = ("0000", "1000", "0001", "0011")
HISTORICAL = {
    setting: f"references/historical_bjs300/{setting}/raw.csv"
...
def main() -> int:
    ...
    for setting in SETTINGS:
        array_cases = [f"ARRAY_{setting}_{mask}" for mask in MASKS]
        array_paths = [raw_path(case) for case in array_cases]
        specs = signal_specs("ARRAY")
        render_comparison(
            manifest_entries, f"{setting}_MASKS_SIGNAL_PATH.html", array_cases, array_paths,
            specs["SIGNAL_PATH"], EXP / "plots" / "comparison" / f"{setting}_MASKS_SIGNAL_PATH.html",
        )
        render_comparison(
            manifest_entries, f"{setting}_MASKS_QB.html", array_cases, array_paths,
            specs["QB_STATE"], EXP / "plots" / "comparison" / f"{setting}_MASKS_QB.html",
        )
        render_comparison(
            manifest_entries, f"{setting}_MASKS_JTL.html", array_cases, array_paths,
            specs["JTL_CHAIN"], EXP / "plots" / "comparison" / f"{setting}_MASKS_JTL.html",
        )

        single_case = f"SINGLE_{setting}_1"
        array_case = f"ARRAY_{setting}_0001"
        render_comparison(
            manifest_entries, f"{setting}_SINGLE_VS_ARRAY1.html", [single_case, array_case],
            [raw_path(single_case), raw_path(array_case)], matched_comparison_labels(),
            EXP / "plots" / "comparison" / f"{setting}_SINGLE_VS_ARRAY1.html",
        )

        historical_path = EXP / HISTORICAL[setting]
        bjs400_case = f"ARRAY_{setting}_1000"
        render_comparison(
            manifest_entries, f"{setting}_BJS300_VS_BJS400_1000.html",
            [f"BJS300_{setting}", bjs400_case], [historical_path, raw_path(bjs400_case)],
            matched_comparison_labels(),
            EXP / "plots" / "comparison" / f"{setting}_BJS300_VS_BJS400_1000.html",
        )
    ...
    manifest = {
        "schema": "bjs400-array-single-flat-visualization-manifest-v1",
        ...
        "no_extra_masks": True,
        "status": "PASS" if len(standalone) == 144 and len(comparisons) == 20 else "FAIL",
    }

# bvm-sfq-receiver-r15c-jset-causal-20260823 topology
...
- source deck：`test/exploration/bvm-sfq-receiver-r15c-jset-causal-20260823/inputs/logical1-read.cir`
...
- `.include jset_causal.cir`

- subcircuit：`BVM`
- subcircuit：`JSET_CAUSAL`

#!/usr/bin/env python3
"""Primary raw-CSV analysis for the R1b AREA=.08 activation point."""
...
TWO_PI = 2.0 * math.pi
POINT = {
    "id": "diff-a008-b07-r100-series-return",
    "trigger_area": 0.50,
...
def main():
    ...
    result = {
        "document_type": "r1b_raw_analysis",
        "analysis_version": "r1b-output-jj-area008-1",
        "phi0_Wb": PHI0_WB,
        "metric_boundary": (
    ...
    out = ROOT / "analysis" / "r1b-analysis.json"

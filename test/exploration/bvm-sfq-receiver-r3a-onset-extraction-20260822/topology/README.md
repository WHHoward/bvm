# bvm-sfq-receiver-r3a-onset-extraction-20260822 topology
...
- source deck：`test/exploration/bvm-sfq-receiver-r3a-onset-extraction-20260822/inputs/read1.cir`
- topology.svg：35 primitives，0 mutuals。
...
- `.include r3a-receiver.cir`

- subcircuit：`BVM`
- subcircuit：`R3A_SOURCE_EXTRACTOR`

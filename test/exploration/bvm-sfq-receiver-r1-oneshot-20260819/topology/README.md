# bvm-sfq-receiver-r1-oneshot-20260819 topology
...
- source deck：`test/exploration/bvm-sfq-receiver-r1-oneshot-20260819/inputs/a050-b15-read1.cir`
...
- `.include r1_receiver.cir`

- subcircuit：`BVM`
- subcircuit：`R1_RECEIVER`
